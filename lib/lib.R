...
createGisadUploadForm <- function(genomeMetaData, gisaideUser){
  openxlsx::write.xlsx(
    data.frame(Submitter = rep(gisaideUser, nrow(genomeMetaData)),
               ...
               'Location' = 'North America/USA/SE Pennsylvania',
               ...
               'Authors' =  'John K. Everett, Kyle Rodino, Shantan Reddy, Aoife M. Roche, Young Hwang, Scott Sherrill-Mix, Samantha A. Whiteside, Jevon Graham-Wooten, Layla A. Khatib, Ayannah S. Fitzgerald, Arupa Ganguly, Mike Feldman, Brendan Kelly, Ronald G. Collman and Frederic Bushan',
               'Comment' = NA,
