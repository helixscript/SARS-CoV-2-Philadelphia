...
varHeatMap2 <- function(x){
  ...
  ggplot(vt2, aes(seqSample, percentAlt, fill = ALT, label = reads)) +
    ...
    geom_text(aes(seqSample, 0.5, label = reads), inherit.aes = FALSE, size = 3) +
    facet_grid(s~sampleName, scales = 'free_x', switch = 'y') +
    labs(x = '', y = '') +
    theme(strip.text.y = element_text(angle = 180),
          ...
          line = element_blank(), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
} 
